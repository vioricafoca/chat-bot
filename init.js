(function() {
  ...
  const cssContent = `
    ...
    .bpw-composer textarea::placeholder {
      ...
      font-family: -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue, Icons16, sans-serif; /* Updated font-family */
    }
    #messages {
      padding: 10px;
    ...
    #messages::-webkit-scrollbar {
      width: 4px; /* Adjust the width of the scrollbar to make it thinner */
      border-radius: 20px;
    }
    ...
    #messages::-webkit-scrollbar-thumb:hover {
      background: #d4dae1; /* Color of the scrollbar thumb on hover */
    }
    /* Style for Firefox */
    #messages {
      scrollbar-width: thin; /* Makes the scrollbar thin */
      scrollbar-color: #e0e6e0 #ffffff; /* Thumb color and track color */
      border-radius: 20px;
    }
    .message {
      display: flex;
    ...
    .bpw-composer button {
      ...
      align-items: center;
      max-height: 30px;
      border-radius: 15px; /* Rounded corners on the right side */
      cursor: pointer;
    }
    .bpw-composer button.visible {
      display: flex; /* Show the button when it has the 'visible' class */
    }
    ...
    #chat {
      ...
      overflow: hidden;
      transition: transform 0.2s ease, opacity 0.2s ease; /* Reduced duration */
          ...
          <button type="button" tabindex="-1" id="btn-delete" class="bpw-header-icon bpw-header-icon-delete">
            <i>
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="20" viewBox="0 0 20 20" fill="currentColor">
                ...
                <path d="M21 11H7.41l5.3-5.29a1 1 0 0 0-1.42-1.42l-7 7a1 1 0 0 0 0 1.42l7 7a 1 1 0 0 0 1.42-1.42L7.41 13H21a1 1 0 1 0 0-2z" />
              </svg>
            </i>
          </button>
